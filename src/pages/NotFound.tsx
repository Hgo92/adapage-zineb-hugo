...
export default function NotFound() {
    return (
<main className="min-h-screen relative overflow-hidden pt-32 bg-linear-to-br from-indigo-100 via-pink-100 to-yellow-100">
    ...
    <Link to="/"><button className="relative w-40 h-20 px-4 py-2 rounded-lg bg-linear-to-br from-indigo-100 to-pink-100  text-gray-900 font-medium ring-1 ring-indigo-200 transition-all duration-300 ease-out  hover:ring-indigo-400 hover:scale-105 hover:shadow-[0_0_25px_rgba(99,102,241,0.35)] text-xl">
        Revenir à l'accueil
    </button></Link>
    </div>
</main>
