...
export default function Navbar() {
  return (
    <nav className="fixed top-0 w-full bg-white/90 backdrop-blur-md shadow-md z-50 h-20">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-8 py-4">
        ...
        <div className="flex items-center">
          <Link to="/"><img 
            src={graceLogo}
            alt="Grace Hopper"
            className="h-12 w-28 object-contain transition hover:scale-120"
          /></Link>
        </div>
        ...
        <ul className="flex gap-10 text-lg text-gray-700 font-semibold">
          ...
          <li>
            <Link to="/" className="relative
                                        ...
                                        bg-linear-to-br from-indigo-100 to-pink-100
